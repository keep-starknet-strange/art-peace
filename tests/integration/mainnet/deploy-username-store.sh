...
USERNAME_STORE_SIERRA_FILE=$ONCHAIN_DIR/target/dev/art_peace_UsernameStore.contract_class.json
...
echo "starkli declare --network mainnet --keystore $STARKNET_KEYSTORE --account $STARKNET_ACCOUNT --watch $USERNAME_STORE_SIERRA_FILE --compiler-version 2.6.2"
USERNAME_STORE_DECLARE_OUTPUT=$(starkli declare --network mainnet --keystore $STARKNET_KEYSTORE --account $STARKNET_ACCOUNT --watch $USERNAME_STORE_SIERRA_FILE --compiler-version 2.6.2 2>&1)
...
echo "starkli deploy --network mainnet --keystore $STARKNET_KEYSTORE --account $STARKNET_ACCOUNT --watch $USERNAME_STORE_CONTRACT_CLASSHASH"
starkli deploy --network mainnet --keystore $STARKNET_KEYSTORE --account $STARKNET_ACCOUNT --watch $USERNAME_STORE_CONTRACT_CLASSHASH

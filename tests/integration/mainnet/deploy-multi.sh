...
ART_PEACE_SIERRA_FILE=$ONCHAIN_DIR/target/dev/art_peace_MultiCanvas.contract_class.json
...
echo "starkli deploy --network mainnet --keystore $STARKNET_KEYSTORE --account $STARKNET_ACCOUNT --watch $ART_PEACE_CONTRACT_CLASSHASH $CALLDATA"
starkli deploy --network mainnet --keystore $STARKNET_KEYSTORE --account $STARKNET_ACCOUNT --watch $ART_PEACE_CONTRACT_CLASSHASH $CALLDATA

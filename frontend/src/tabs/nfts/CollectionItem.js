  ...
  return (
    <div className="CollectionItem">
      <div className="CollectionItem__imagecontainer">
        <img src={props.image} alt="nftimg" className="CollectionItem__image" />
      </div>
      <div className="CollectionItem__info">
        <div className="CollectionItem__info__item" style={{backgroundColor: 'rgba(200, 0, 0, 0.2)'}}>
          <p>Pos</p>
          <p>({posx}, {posy})</p>
        </div>
        <div className="CollectionItem__info__item" style={{backgroundColor: 'rgba(0, 200, 0, 0.2)'}}>
          <p>Size</p>
          <p>{props.width}x{props.height}</p>
        </div>
        <div className="CollectionItem__info__item" style={{backgroundColor: 'rgba(0, 0, 200, 0.2)'}}>
          <p>Block</p>

...
const EventItem = props => {
  ...
  return (
    <div className="EventItem" style={{background: `linear-gradient(to bottom right, hsla(${color}, 100%, 50%, 30%), hsla(${(color + btrColorOffset) % 360}, 100%, 50%, 30%)`}}>
      <div style={{position: 'relative'}}>
        <img src={props.template.image} alt="nftimg" className="EventItem__image" />
      ...
      <div className="EventItem__info">
        ...
        <div className="EventItem__info__item" style={{backgroundColor: 'rgba(0, 0, 200, 0.2)'}}>
          <p>Reward</p>
          <p>{props.template.reward} {props.template.reward_token}</p>
        </div>
        }
        <div className="EventItem__info__item" style={{backgroundColor: 'rgba(200, 0, 0, 0.2)'}}>
          <p>Pos</p>
          <p>({posx}, {posy})</p>
        </div>
        <div className="EventItem__info__item" style={{backgroundColor: 'rgba(0, 200, 0, 0.2)'}}>
          <p>Size</p>
          <p>{props.template.width}x{props.template.height}</p>
        </div>
        { props.template.creator !== undefined &&
        <div className="EventItem__info__item" style={{backgroundColor: 'rgba(200, 200, 0, 0.2)'}}>
          <p>Creator</p>

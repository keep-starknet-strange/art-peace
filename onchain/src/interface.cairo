...
pub trait IArtPeace<TContractState> {
    // Get canvas info
    fn get_pixel(self: @TContractState, pos: u128) -> u32;
    fn get_pixel_xy(self: @TContractState, x: u128, y: u128) -> u32;
    ...
    fn place_pixel(ref self: TContractState, pos: u128, color: u32);
    fn place_pixel_xy(ref self: TContractState, x: u128, y: u128, color: u32);
    fn place_extra_pixels(ref self: TContractState, positions: Array<u128>, colors: Array<u32>);
    ...
    // Get color info
    fn get_color_count(self: @TContractState) -> u32;
    ...
    fn get_max_days(self: @TContractState) -> u32;
    ...
    fn get_daily_quests(self: @TContractState) -> Span<starknet::ContractAddress>;

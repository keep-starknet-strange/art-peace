    ...
    const result = await account.execute([
      {
        ...
        entrypoint: "0x4cde3e7cce0b9bbcf08d8b891f1b35302858ffd1251226afe10443e3482114",
        calldata,
      },
    ]);
...
export const placePixelsCall =
  ...
  try {
    ...
    const result = await account.execute([
      {
        contractAddress: CANVAS_CONTRACT_ADDRESS,
        entrypoint: "0x349d91d0c45d220dfd1b14c43caa2f54408ef08d0e0458700fb3b15d51e0173",
        calldata,
      },
    ]);
    console.log("Tx hash:", result.transaction_hash);
...
export const createCanvasCall =
  ...
  try {
    ...
    const result = await account.execute([
      {
        contractAddress: CANVAS_CONTRACT_ADDRESS,
        entrypoint: "0x1aabaa11b54a06844d75d9e308d96a31f8622c675bec90b7048e6fac0d13326",
        calldata,
      },
    ]);
    console.log("Tx hash:", result.transaction_hash);
...
export const addStencilCall =
  ...
  try {
    ...
    const result = await account.execute([
      {
        contractAddress: CANVAS_CONTRACT_ADDRESS,
        entrypoint: "0x280406faa355e710f583d01a21d3b1733f5b03e50693052a70121ecc4c86de6",
        calldata,
      },
    ]);
    console.log("Tx hash:", result.transaction_hash);
...
export const favoriteStencilCall =
  ...
  try {
    ...
    const result = await account.execute([
      {
        contractAddress: CANVAS_CONTRACT_ADDRESS,
        entrypoint: "0x1ef4e50dbc45a8a37b18f14db84f51d9837fe10ff6e57b226f470c242a543e1",
        calldata,
      },
    ]);
    console.log("Tx hash:", result.transaction_hash);
...
export const unfavoriteStencilCall =
  ...
  try {
    ...
    const result = await account.execute([
      {
        contractAddress: CANVAS_CONTRACT_ADDRESS,
        entrypoint: "0x2d6aee5967300c480128cada5d3d915945583f25faf54499c0ca9309aef5780",
        calldata,
      },
    ]);
    console.log("Tx hash:", result.transaction_hash);
